...
interface ExpenseFormState {
    description: string;
    amount: string;
    paidBy: string; // Now stores email string (input value)
}
...
export default function AddExpensePage() {
        ...
        if (user && groupId) {
            const fetchData = async () => {
                try {
                    ...
                    // Default paidBy removed as per request (starts empty)
                    // if (user.email) {
                    //    setFormData(prev => ({ ...prev, paidBy: user.email! }));
                    // }
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            let finalPaidById = user?.id; // Default to current user
            ...
            if (payerMember) {
                ...
                // If custom name, append to description
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-20">
                <div className="max-w-7xl mx-auto px-4 py-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl sm:text-2xl font-bold text-[#1F2937]">Add Expense</h1>
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                <div className="bg-white rounded-3xl shadow-xl p-6 sm:p-8 space-y-8">
                    ...
                    <div className="flex justify-center -mt-2">
                        <div className="w-20 h-20 bg-gradient-to-br from-[#FF6B35] to-[#FF8E53] rounded-3xl flex items-center justify-center shadow-lg shadow-orange-200 transform transition-transform hover:scale-105 duration-300">
                  ...
                  ${errors.description
                    ...
                    ${errors.amount
                            ...
                            {/* Split Preview */}
                            {splitAmount > 0 && (
                                <div className="flex items-center justify-center gap-2 mt-2 py-2 px-4 bg-gray-50 rounded-lg border border-gray-100 mx-auto w-fit">
                                    <UserGroupIcon className="text-[#FF6B35]" />
